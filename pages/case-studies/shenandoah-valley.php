<div class="container py-5">
    ...
    <div class="fs-5">
        <div class="card bg-light text-dark border-0 mb-4">
            <div class="card-body">
                <div class="row">
        ...
        <h2 class="fw-bold text-primary">
            <i class="fa-duotone fa-network-wired me-2" aria-hidden="true"></i>1. System Architecture: The Constraint
        </h2>
        ...
        <ul class="list-unstyled">
            <li class="mb-2"><i class="fa-duotone fa-check-circle text-success me-2" aria-hidden="true"></i><strong>Primary Route:</strong> Stay on I-81 Northbound.</li>
            <li class="mb-2"><i class="fa-duotone fa-arrow-right-from-bracket text-warning me-2" aria-hidden="true"></i><strong>Failover Nodes:</strong> Exits 180 (Glasgow) and 188 (Lexington) identified as early abort points.</li>
            <li class="mb-2"><i class="fa-duotone fa-handshake text-info me-2" aria-hidden="true"></i><strong>User Permission:</strong> Jordan provided <em>Informed Consent</em> to attempt the route.</li>
        </ul>

        <h2 class="fw-bold mt-5 text-primary">
            <i class="fa-duotone fa-gauge-max me-2" aria-hidden="true"></i>2. The Stress Test (Northbound I-81)
        </h2>
        ...
        <h2 class="fw-bold mt-5 text-danger">
            <i class="fa-duotone fa-triangle-exclamation me-2" aria-hidden="true"></i>3. Critical Failure: The Override
        </h2>
        ...
        <div class="alert alert-danger border-danger d-flex align-items-start" role="alert">
            <i class="fa-duotone fa-shield-xmark fa-2x me-3 mt-1" aria-hidden="true"></i>
            <div>
        ...
        <h2 class="fw-bold mt-5 text-success">
            <i class="fa-duotone fa-kit-medical me-2" aria-hidden="true"></i>4. Disaster Recovery: The Fishersville Protocol
        </h2>
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                <div class="card h-100 border-warning bg-warning bg-opacity-10">
                    <div class="card-body">
                        <h4 class="h5 card-title"><i class="fa-duotone fa-brake-warning me-2" aria-hidden="true"></i>Phase A: The Hard Exit</h4>
            ...
            <div class="col-md-6 mt-3 mt-md-0">
                <div class="card h-100 border-success bg-success bg-opacity-10">
                    <div class="card-body">
                        <h4 class="h5 card-title"><i class="fa-duotone fa-mountain-sun me-2" aria-hidden="true"></i>Phase B: Redundant Routing</h4>
        ...
        <div class="p-5 mb-4 bg-dark text-white rounded-3 position-relative overflow-hidden">
            <i class="fa-duotone fa-microchip position-absolute top-0 end-0 text-white opacity-10" style="font-size: 10rem; transform: rotate(-15deg); margin-top: -2rem; margin-right: -2rem;" aria-hidden="true"></i>
            
            <div class="position-relative z-1">
                <h2 class="display-6 fw-bold border-bottom border-secondary pb-3 mb-3">
                    <i class="fa-duotone fa-code-merge me-2" aria-hidden="true"></i>The Engineering Takeaway
                </h2>
