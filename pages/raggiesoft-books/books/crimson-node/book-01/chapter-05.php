<?php
// pages/raggiesoft-books/books/crimson-node/book-01/chapter-05.php

$nav = [
    "prev" => "/raggiesoft-books/books/crimson-node/book-01/chapter-04",
    "hub"  => "/raggiesoft-books/books/crimson-node/book-01",
    "next" => "#"
];
?>
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="mb-5 border-bottom border-secondary-subtle pb-4">
                <h1 class="display-4 fw-bold" style="font-family: 'Impact', sans-serif; letter-spacing: 2px;">
                    CHAPTER <span class="text-danger">5</span>
                </h1>
                <h2 class="h3 text-muted text-uppercase tracking-wide">Interlude: The Reckoning</h2>
                <div class="d-flex align-items-center mt-3 text-secondary">
                    <i class="fa-duotone fa-calendar-day me-2"></i>
                    <span class="fw-medium">Tuesday, May 4, 1999</span>
                </div>
            </div>
