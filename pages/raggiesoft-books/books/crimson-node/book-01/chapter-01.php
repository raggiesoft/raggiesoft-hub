<?php
// pages/raggiesoft-books/books/crimson-node/book-01/chapter-01.php
$nav = [
    'prev' => null,
    'overview' => ['url' => '/raggiesoft-books/books/crimson-node/book-01', 'label' => 'Book 1 Overview'],
    'next' => ['url' => '/raggiesoft-books/books/crimson-node/book-01/chapter-02', 'label' => 'Chapter 2']
];
?>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-9">
            ...
            <div class="story-content fs-5" style="line-height: 1.8;">
                ...
                <p>
                    Courtney laughed, the sound warm and unguarded. It felt easy. The wheelchair, the chest harness, the silent presence of Mr. Vance&mdash;none of it mattered to her in that moment. She just liked him. 
                </p>
                <p>
