<?php
// pages/raggiesoft-books/encyclopedia/sensory-scale.php
// REFERENCE: The Universal Sensory Distress Scale (Levels 1-5)
// Usage: Canonical reference for all Autistic characters in the RaggieSoft Universe.

$pageTitle = "System Reference: The Sensory Scale";
?>
...
<div class="container py-5">
    ...
    <div class="row justify-content-center mb-3">
        <div class="col-lg-10">
            <a href="/raggiesoft-books/encyclopedia" class="text-decoration-none text-body-secondary small text-uppercase fw-bold">
    ...
    <div class="row justify-content-center mb-5">
        <div class="col-lg-10 text-center">
            <div class="d-inline-block border border-primary px-3 py-1 rounded-pill text-uppercase font-monospace small text-primary-emphasis mb-3 bg-primary-subtle">
                <i class="fa-solid fa-book-sparkles me-2"></i>System Reference Document
            </div>
            <h1 class="display-4 fw-bold mb-2 text-uppercase brand-font">
                The Sensory Distress Scale
            </h1>
            <p class="lead text-body-secondary mx-auto" style="max-width: 800px;">
                The universal framework used to describe the escalation of sensory overload in RaggieSoft narratives.
            </p>
            <p class="small text-muted fst-italic">
                Primary Users: Ryan O'Connell (Engine Room), Cassidy O'Connell (Engine Room), Sarah (Family).
            </p>
        </div>
    </div>
                ...
                <div class="card-body p-4">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 border-start border-secondary-subtle ps-4 d-none d-md-block">
                            <small class="text-uppercase fw-bold text-success-emphasis">Narrative Example:</small>
                            <p class="small text-body-secondary fst-italic mb-0">
                                Cassidy (<em>Engine Room</em>) aggressively chewing gum while mixing a track because the snare drum sound isn't sitting right.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="card h-100 border-info-subtle shadow-sm">
                ...
                <div class="card-body p-4">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 border-start border-secondary-subtle ps-4 d-none d-md-block">
                            <small class="text-uppercase fw-bold text-info-emphasis">Narrative Example:</small>
                            <p class="small text-body-secondary fst-italic mb-0">
                                Sarah (<em>Family</em>) typing on her phone instead of speaking because her voice feels "too heavy" to use.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="card h-100 border-warning-subtle shadow-sm">
                ...
                <div class="card-body p-4">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 border-start border-secondary-subtle ps-4 d-none d-md-block">
                            <small class="text-uppercase fw-bold text-warning-emphasis">Narrative Example:</small>
                            <p class="small text-body-secondary fst-italic mb-0">
            ...
            <div class="card h-100 border-danger-subtle shadow-sm">
                ...
                <div class="card-body p-4">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 border-start border-secondary-subtle ps-4 d-none d-md-block">
                            <small class="text-uppercase fw-bold text-danger-emphasis">Narrative Example:</small>
                            <p class="small text-body-secondary fst-italic mb-0">
    ...
    <div class="row justify-content-center mb-5">
        <div class="col-lg-10">
            <div class="card card-blackout border-3 shadow-lg overflow-hidden">
                        ...
                        <div class="col-md-4 border-start border-secondary ps-4 d-none d-md-block">
                            <div class="p-3 bg-dark border border-secondary rounded">
                                ...
                                <p class="small text-white fst-italic mb-2">
                                    ...
                                    <strong>Subject:</strong> Ryan O'Connell<br>
                                    <strong>Trigger:</strong> Threat to Master Tapes<br>
                                    <strong>Severity:</strong> MAXIMUM
                                </p>
                            </div>
                        </div>
                    </div>
