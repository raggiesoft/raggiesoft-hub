        ...
        <div class="col-lg-8 d-flex align-items-center">
            <div class="card-body p-4 p-lg-5">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <span class="badge border text-body bg-transparent" style="border-color: #6610f2 !important; color: #6610f2 !important;">
                        FFmpeg / LAME
                    </span>
                </div>
                
                <h1 class="display-4 fw-bold mb-2 text-body">Harper</h1>
                <p class="lead mb-4" style="color: #6610f2;">The Studio Engineer</p>
                
                <figure class="border-start ps-3 mb-0" style="border-color: #6610f2 !important;">
...
<div class="row g-5 mb-5">
    <div class="col-md-12 col-xl-6">
        <div class="p-4 h-100 rounded-3 border bg-body-tertiary">
            <h3 class="border-bottom pb-3 mb-4" style="color: #6610f2;"><i class="fa-duotone fa-waveform-lines me-2"></i>The Transcoder</h3>
            ...
            <ul class="list-group list-group-flush bg-transparent mb-4">
                <li class="list-group-item bg-transparent px-0"><i class="fa-duotone fa-magnifying-glass-waveform me-2" style="color: #6610f2;"></i><strong>Discovery:</strong> Recursively scans the workspace for fresh Master WAV files.</li>
                <li class="list-group-item bg-transparent px-0"><i class="fa-duotone fa-file-mp3 me-2" style="color: #6610f2;"></i><strong>Transcoding:</strong> Uses FFmpeg to generate web-optimized MP3 (320kbps) and OGG mirrors.</li>
                <li class="list-group-item bg-transparent px-0"><i class="fa-duotone fa-box-archive me-2" style="color: #6610f2;"></i><strong>Archival:</strong> Auto-generates ZIP archives for licensing deliverables.</li>
            </ul>
    ...
    <div class="col-md-12 col-xl-6">
        <div class="p-4 h-100 rounded-3 border bg-opacity-10" style="background-color: rgba(102, 16, 242, 0.05); border-color: #6610f2 !important;">
            <h3 class="border-bottom pb-3 mb-4" style="color: #6610f2; border-color: #6610f2 !important;"><i class="fa-duotone fa-headphones-simple me-2"></i>The Audiophile</h3>
...
<div class="row">
    <div class="col-12">
        <div class="card shadow-lg font-monospace" style="background-color: #0d1117; color: #c9d1d9; border: 1px solid #6610f2;">
            <div class="card-header fw-bold d-flex justify-content-between align-items-center" 
                 style="background-color: rgba(102, 16, 242, 0.15); border-bottom: 1px solid #6610f2; color: #a277ff;">
            ...
            <div class="card-body p-4">
                <div style="opacity: 1;">
                    ...
                    <div class="mb-3 ps-3 border-start border-opacity-25" style="border-color: #6610f2 !important; color: #c9d1d9;">
                        <span style="color: #a277ff;">🎧 HARPER:</span> Alright! Firing up the mixing board (v18)... Let's make some noise!<br>
                        <span style="color: #8b949e;">🎚️ Targeting Studio Archives: ../engine-room-records/artists</span><br><br>
                        
                        <span style="color: #a277ff;">[1/3] Processing: "Neon Hearts (1989)"</span><br>
                        &nbsp;&nbsp;&nbsp;> Found Master: <span style="color: #79c0ff;">01-Neon-Hearts.wav</span> (24-bit / 48kHz)<br>
                        ...
                        <span style="color: #a277ff;">[2/3] Processing: "Electric Color (1987)"</span><br>
                        &nbsp;&nbsp;&nbsp;> Found Master: <span style="color: #79c0ff;">07-Light-Up-The-Night.wav</span><br>
                        &nbsp;&nbsp;&nbsp;> FFmpeg: Encoding... [====================] 100%<br>
                        &nbsp;&nbsp;&nbsp;<span style="color: #3fb950;">✓ Track ready for streaming.</span><br><br>
                        
                        <span style="color: #a277ff;">[3/3] Creating License Packs (7-Zip)</span><br>
                        &nbsp;&nbsp;&nbsp;> Compressing: archives/electric-color-wav.7z ... <span style="color: #3fb950;">OK</span>
                    </div>
                    
                    <p class="mb-0 mt-3">
                        <span style="color: #a277ff;">🎧 HARPER:</span> Mixdown complete! That sounded awesome.<br>
...
<style>
    ...
    .blink-cursor {
        ...
        color: #a277ff; /* Light Purple cursor */
    }
    @keyframes blink {
        0%, 100% { opacity: 1; }
        50% { opacity: 0; }
