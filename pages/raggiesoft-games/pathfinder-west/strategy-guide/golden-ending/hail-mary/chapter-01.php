    ...
    <article class="narrative-prose fs-5 lh-lg">
        ...
        <div class="row my-4">
            <div class="col-md-6 text-center">
                <img src= $cdnBaseUrl . "/engine-room-records/artists/the-paper-wall/2001-static-and-silence-book-1/album-art.jpg" alt="Static & Silence Book 1" class="img-fluid rounded shadow-sm">
                <p class="text-muted small mt-2">Book 1: The Long Road West</p>
            </div>
            <div class="col-md-6 text-center">
                <img src= $cdnBaseUrl . "/engine-room-records/artists/the-paper-wall/2001-static-and-silence-book-2/album-art.jpg" alt="Static & Silence Book 2" class="img-fluid rounded shadow-sm">
