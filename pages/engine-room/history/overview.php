...
// UPDATED: Fixed for Light Mode / Dark Mode adaptability (Semantic Classes).
...
<div class="container py-5">
    ...
    <div class="row justify-content-center mb-5">
        <div class="col-lg-8 text-center">
            <span class="badge bg-warning text-black rounded-pill px-3 py-2 mb-3 text-uppercase letter-spacing-1 shadow-sm">
                <i class="fa-duotone fa-file-archive me-2"></i>Corporate Archives
            </span>
            <h1 class="display-4 fw-bold mb-2 text-uppercase" style="font-family: 'Impact', sans-serif; letter-spacing: 1px;">
                Engine Room History
            </h1>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="card mb-5 shadow-lg position-relative overflow-hidden border-secondary border-opacity-25">
                ...
                <div class="row g-0">
                    <div class="col-md-5 position-relative">
                        <img src="https://assets.raggiesoft.com/stardust-engine/images/story/friction-photoshoot.jpg" 
                             ...
                             alt="The Stardust Engine waiting in a cold warehouse.">
                    ...
                    <div class="col-md-7">
                        <div class="card-body p-4 p-md-5">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <h3 class="h4 fw-bold mb-0">The Friction Catastrophe</h3>
                            ...
                            <div class="d-grid gap-2 d-md-block">
                                <a href="/engine-room/history/friction" class="btn btn-outline-danger rounded-pill px-4">
                ...
                <div class="col-md-10">
                    <div class="card bg-body-tertiary border-secondary border-opacity-25">
                        <div class="card-body p-3 d-flex align-items-center">
                            <div class="me-3 text-body-secondary opacity-50">
                                <i class="fa-duotone fa-box-archive fa-2x"></i>
                            </div>
                            <div>
                                <h5 class="h6 fw-bold text-body mb-0">1995: The "Ironhead" War Chest</h5>
                                <small class="text-body-secondary font-monospace">The crowdfunding campaign that built the Blacksburg Studio.</small>
                            </div>
                            <div class="ms-auto">
                                <span class="badge bg-secondary bg-opacity-25 text-body-secondary">DIGITIZING...</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card mb-4 shadow-lg position-relative overflow-hidden border-secondary border-opacity-25">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-7 order-md-1">
                        <div class="card-body p-4 p-md-5">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <h3 class="h4 fw-bold mb-0">The $150M Refusal</h3>
                            ...
                            <div class="d-grid gap-2 d-md-block">
                                <a href="/engine-room/history/nine-figure-refusal" class="btn btn-outline-success rounded-pill px-4">
                                    <i class="fa-duotone fa-file-contract me-2"></i>Access Archive
                                </a>
                                <a href="/engine-room/artists/stardust-engine/lore/book-1/chapter-01" class="btn btn-link text-body-secondary text-decoration-none small">
