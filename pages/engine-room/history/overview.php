            ...
            <div class="timeline-node mb-5 position-relative">
                ...
                <div class="card border-secondary bg-dark text-white shadow-sm">
                    <div class="card-body p-4 p-md-5" style="line-height: 1.7;">
                        ...
                        <a href="/engine-room/artists/stardust-engine/discography/1995-the-warehouse-tapes" class="btn btn-outline-info btn-sm text-uppercase fw-bold font-monospace" aria-label="Access The Warehouse Tapes album archive">
