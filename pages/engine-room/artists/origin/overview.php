...
<div class="container py-5">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/engine-room/artists" class="text-decoration-none">Artists</a></li>
    ...
    <div class="row align-items-center mb-5">
        <div class="col-md-8">
            <h1 class="display-2 fw-bold text-body-emphasis mb-2 text-uppercase" style="font-family: 'Audiowide', sans-serif;">
                Origin
            </h1>
            <p class="h4 text-primary fw-light">
                "The True Light Gleams"
            </p>
        </div>
        <div class="col-md-4 text-md-end">
             <div class="p-5 bg-body-tertiary border rounded text-center text-body-secondary">
                 <i class="fa-duotone fa-user-group fa-3x mb-2"></i>
                 <br>Artist Photo Pending
             </div>
        </div>
    </div>
