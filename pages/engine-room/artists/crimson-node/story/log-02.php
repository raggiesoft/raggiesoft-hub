<?php
// pages/engine-room/artists/crimson-node/story/log-01.php
?>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center mt-5 pt-4 border-top">
                ...
                <a href="/engine-room/artists/crimson-node/story/log-03" class="btn btn-outline-danger">
