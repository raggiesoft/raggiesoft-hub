    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 border-0 shadow-sm" style="border-top: 5px solid var(--bs-purple);">
                <a href="https://assets.raggiesoft.com/shiloh/images/characters/ccc/bouchard/heather-bouchard.jpg" target="_blank">
                    <img src="https://assets.raggiesoft.com/shiloh/images/thumbnails/ccc/bouchard/heather-bouchard-thumb.jpg" class="card-img-top rounded-0" alt="Portrait of Heather Bouchard" style="aspect-ratio: 1/1; object-fit: cover; object-position: center top;">
                </a>
                <div class="card-body">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 border-0 shadow-sm" style="border-top: 5px solid var(--bs-indigo);">
                <a href="https://assets.raggiesoft.com/shiloh/images/characters/ccc/bouchard/hailey-bouchard.jpg" target="_blank">
                    <img src="https://assets.raggiesoft.com/shiloh/images/thumbnails/ccc/bouchard/hailey-bouchard-thumb.jpg" class="card-img-top rounded-0" alt="Portrait of Hailey Bouchard" style="aspect-ratio: 1/1; object-fit: cover; object-position: center top;">
                </a>
                <div class="card-body">
