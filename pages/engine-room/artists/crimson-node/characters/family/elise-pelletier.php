<div class="row">
    ...
    <div class="col-lg-4 mb-4 mb-lg-0">
        <!-- Portrait Image -->
        <a href= $cdnBaseUrl . "/shiloh/images/family/elise-pelletier.jpg" target="_blank" class="d-block mb-4">
            <img src= $cdnBaseUrl . "/shiloh/images/family/elise-pelletier-thumb.jpg" alt="Portrait of Elise Pelletier" class="img-fluid rounded shadow-sm  w-100">
        </a>
