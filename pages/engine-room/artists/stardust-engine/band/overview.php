    ...
    <div class="row justify-content-center mb-5">
        <div class="col-lg-10">
            <div class="card glass-card border-secondary p-2 shadow-lg">
                <img src= $cdnBaseUrl . "/stardust-engine/images/band-members/family-portraits/artist-header-all.jpg" 
    ...
    <div class="row g-5 justify-content-center">
            ...
            <div class="card glass-card border-secondary overflow-hidden">
                <div class="row g-0 align-items-center">
                    <div class="col-md-4 position-relative">
                        <img src= $cdnBaseUrl . "/stardust-engine/images/band-members/ryan.jpg" 
        ...
        <div class="col-lg-10">
            <div class="card glass-card border-secondary overflow-hidden">
                <div class="row g-0 align-items-center">
                    <div class="col-md-4">
                        <img src= $cdnBaseUrl . "/stardust-engine/images/band-members/cassidy.jpg" 
                             class="img-fluid h-100 object-fit-cover" 
                             style="min-height: 300px;"
        ...
        <div class="col-lg-10">
            <div class="card glass-card border-secondary overflow-hidden">
                <div class="row g-0 align-items-center">
                    <div class="col-md-4">
                        <img src= $cdnBaseUrl . "/stardust-engine/images/band-members/holly.jpg" 
                             class="img-fluid h-100 object-fit-cover" 
                             style="min-height: 300px;"
        ...
        <div class="col-lg-10">
            <div class="card glass-card border-secondary overflow-hidden">
                <div class="row g-0 align-items-center">
                    <div class="col-md-4">
                        <img src= $cdnBaseUrl . "/stardust-engine/images/band-members/evan.jpg" 
                             class="img-fluid h-100 object-fit-cover" 
                             style="min-height: 300px;"
        ...
        <div class="col-lg-10">
            <div class="card glass-card border-secondary overflow-hidden">
                <div class="row g-0 align-items-center">
                    <div class="col-md-4">
                        <img src= $cdnBaseUrl . "/stardust-engine/images/band-members/tyler.jpg" 
                             class="img-fluid h-100 object-fit-cover" 
                             style="min-height: 300px;"
