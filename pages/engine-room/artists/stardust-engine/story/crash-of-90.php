...
<div class="container py-5">
    ...
    <div class="row justify-content-center mb-5">
        <div class="col-lg-8 text-center">
            <span class="badge bg-danger text-white rounded-pill px-3 py-2 shadow-sm mb-3">
                <i class="fa-duotone fa-car-crash me-2"></i>Historical Archive
            </span>
    ...
    <div class="row justify-content-center mb-5">
        <div class="col-lg-9 text-body-secondary fs-5">
            ...
            <p>
                <strong>Ryan was driving.</strong> He wouldn't let anyone else do it. He knew the trucks on I-81. He knew the "suicide lane" merges. He was doing everything right—40 MPH in the <strong>Holt Freighter</strong>, hazards on, white-knuckling the wheel while the rest of the family slept in the back.
            </p>
            <p>
