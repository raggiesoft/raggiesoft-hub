...
<div class="container py-5">
    ...
    <div class="row justify-content-center mb-5">
        <div class="col-lg-10">
            <div class="card border-0 shadow-lg bg-white text-dark position-relative" style="min-height: 800px;">
                
                <div class="card-header bg-white border-bottom border-2 border-dark py-4">
                ...
                <div class="card-body p-5">
                    ...
                    <div class="text-center mb-5">
                        ...
                        <div class="bg-light border border-secondary p-3 p-md-4 rounded-3 d-inline-block shadow-sm mw-100">
                            ...
                            <div class="text-success fw-bold text-uppercase mt-2">
                                <i class="fa-solid fa-check-circle me-2"></i>All-Cash Transaction
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-5 pt-5 border-top border-secondary position-relative">
