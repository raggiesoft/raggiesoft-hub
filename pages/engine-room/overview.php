...
<div class="container py-5">
    ...
    <div class="row justify-content-center mb-5">
        <div class="col-lg-8 text-center">
            <span class="badge bg-warning text-black rounded-pill px-3 py-2 mb-3 text-uppercase letter-spacing-1 shadow-glow">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="card bg-dark border-secondary mb-5 shadow-lg position-relative overflow-hidden">
                    ...
                    <div class="col-md-7">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <div class="d-grid gap-2 d-md-block">
                                <a href="/engine-room/history/friction" class="btn btn-outline-light rounded-pill px-4">
            ...
            <div class="card bg-dark border-secondary mb-4 shadow-lg position-relative overflow-hidden">
