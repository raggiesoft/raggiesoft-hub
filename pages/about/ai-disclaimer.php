    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            ...
            <div class="text-center mb-5">
                <h1 class="fw-bold display-5 mb-3 text-body-emphasis">AI & The Creative Process</h1>
                <p class="lead text-body-secondary mx-auto" style="max-width: 700px;">
                    ...
                    <div class="card h-100 border-success shadow-sm">
                        ...
                        <div class="card-body p-4 d-flex flex-column bg-body">
                            ...
                            <ul class="list-unstyled small text-body-secondary flex-grow-1">
                                ...
                                <li class="mb-2"><i class="fa-solid fa-check text-success me-2" aria-hidden="true"></i>Drafts initial lyric concepts and world-building themes.</li>
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-warning shadow-sm">
                        ...
                        <div class="card-body p-4 d-flex flex-column bg-body">
                            ...
                            <ul class="list-unstyled small text-body-secondary flex-grow-1">
                                <li class="mb-2"><i class="fa-solid fa-check text-warning me-2" aria-hidden="true"></i>Generates original instrumentation and melodies.</li>
                                <li class="mb-2"><i class="fa-solid fa-check text-warning me-2" aria-hidden="true"></i>Synthesizes all vocal performances.</li>
