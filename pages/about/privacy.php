        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body p-4 p-lg-5">
                    ...
                    <h2 class="h4 fw-bold mt-5 mb-3">2. Information I Collect</h2>
                    
                    <h3 class="h5 h6 fw-bold text-primary">A. Voluntary Information (Microsoft Bookings)</h3>
                    ...
                    <h3 class="h5 h6 fw-bold text-primary">B. Automated Analytics (Google)</h3>
                    ...
                    <h3 class="h5 h6 fw-bold text-primary">C. Server Logs (Security)</h3>
                    ...
                    <h2 class="h4 fw-bold mt-5 mb-3">4. Contact Me</h2>
