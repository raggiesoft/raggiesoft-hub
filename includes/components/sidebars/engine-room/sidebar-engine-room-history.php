...
<div class="sticky-top" style="top: 100px;">
    ...
    <wa-card class="rounded-0 border-secondary mb-4 shadow-sm w-100 p-0" style="--wa-panel-bg: transparent; --body-padding: 0; --header-padding: 0;">
        <div slot="header" class="bg-transparent text-body-emphasis fw-bold text-uppercase border-bottom border-secondary font-monospace small px-3 py-2">
