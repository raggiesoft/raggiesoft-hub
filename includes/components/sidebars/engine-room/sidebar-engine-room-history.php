...
<div class="sticky-top" style="top: 100px;">
    ...
    <wa-card class="bg-dark text-white rounded-0 border-secondary mb-4 shadow-sm w-100 wa-theme-dark" data-bs-theme="dark" style="--wa-panel-bg: #212529; --body-padding: 0; --header-padding: 0;">
    ...
    <!-- SECURITY REMINDER -->
    <div class="alert bg-black border-secondary text-white-50 p-3 font-monospace shadow-sm wa-theme-dark" data-bs-theme="dark" style="font-size: 0.75rem;">
