            ...
            <div class="row g-0">
                ...
                <div class="col-lg-6 border-end border-secondary border- p-3">
                    ...
                    <ul class="list-unstyled mb-4">
                        ...
                        <wa-dropdown-item href="/engine-room/artists/stardust-engine/story/nine-figure-refusal/ucc-search-report" class="rounded"><i class="fa-duotone fa-file-certificate me-2 "></i>UCC Search Report</wa-dropdown-item>
