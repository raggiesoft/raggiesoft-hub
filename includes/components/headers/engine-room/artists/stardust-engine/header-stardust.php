  ...
  <wa-dropdown placement="bottom-start" hoist>
    <wa-button slot="trigger" appearance="plain">
      ...
      <wa-dropdown-item onclick="navigateTo('/engine-room/artists/stardust-engine/band')">Overview</wa-dropdown-item>
        ...
        <wa-dropdown-item onclick="navigateTo('/character/stardust-engine/ryan-oconnell')"><i class="fa-duotone fa-microphone me-2"></i>Ryan O'Connell</wa-dropdown-item>
        <wa-dropdown-item onclick="navigateTo('/character/stardust-engine/cassidy-oconnell')"><i class="fa-duotone fa-guitar me-2"></i>Cassidy O'Connell</wa-dropdown-item>
        <wa-dropdown-item onclick="navigateTo('/character/stardust-engine/holly-oconnell')"><i class="fa-duotone fa-scale-balanced me-2"></i>Holly O'Connell</wa-dropdown-item>
        <wa-dropdown-item onclick="navigateTo('/character/stardust-engine/evan-wright')"><i class="fa-duotone fa-drum me-2"></i>Evan Wright</wa-dropdown-item>
        <wa-dropdown-item onclick="navigateTo('/character/stardust-engine/tyler-wright')"><i class="fa-duotone fa-guitar-electric me-2"></i>Tyler Wright</wa-dropdown-item>
    </wa-menu>
  </wa-dropdown>
