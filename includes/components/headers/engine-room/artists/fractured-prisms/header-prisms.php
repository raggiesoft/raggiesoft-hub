...
<ul class="navbar-nav ms-auto mb-2 mb-md-0">
  ...
  <li class="nav-item">
    <a class="nav-link" href="/engine-room/artists/fractured-prisms">
        <i class="fa-duotone fa-house me-2"></i>The Square
    </a>
  </li>

  <li class="nav-item">
    <a class="nav-link" href="/engine-room/artists/fractured-prisms/story">
        <i class="fa-duotone fa-book-journal-whills me-2"></i>Lore
    </a>
  </li>

  <li class="nav-item">
    <a class="nav-link" href="/engine-room/artists/fractured-prisms/discography">
