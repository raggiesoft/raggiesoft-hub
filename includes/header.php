...
// Features: Dynamic Themes, CDN, Page Loader.
// Behavior: Always Sticky, Never Floating.
...
// --- 2. HEADER BEHAVIOR ---
// We removed the "Immersive" logic. The header is now always sticky.
// It will sit at the top, and content will naturally flow below it.
$navWrapperClass = 'sticky-top'; 
